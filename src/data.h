...
struct Resource
{
    ...
    uint8_t  bank_id       = 0;    // offset 0x07: bank id
    uint32_t bank_offset   = 0;    // offset 0x08: bank offset
    uint16_t unused4       = 0;    // offset 0x0c: unused
    uint16_t packed_size   = 0;    // offset 0x0e: packed size
    uint16_t unused5       = 0;    // offset 0x10: unused
    uint16_t unpacked_size = 0;    // offset 0x12: unpacked size
