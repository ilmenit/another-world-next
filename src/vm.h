...
private: // private interface
    ...
    auto op_setr(Thread& thread) -> void;

    auto op_seti(Thread& thread) -> void;
    ...
    auto op_lsli(Thread& thread) -> void;

    auto op_lsri(Thread& thread) -> void;

    auto op_jump(Thread& thread) -> void;

    auto op_cjmp(Thread& thread) -> void;

    auto op_dbra(Thread& thread) -> void;

    auto op_call(Thread& thread) -> void;

    auto op_ret(Thread& thread) -> void;

    auto op_start(Thread& thread) -> void;

    auto op_reset(Thread& thread) -> void;

    auto op_yield(Thread& thread) -> void;

    auto op_halt(Thread& thread) -> void;

    auto op_load(Thread& thread) -> void;

    auto op_fade(Thread& thread) -> void;
    ...
    auto op_show(Thread& thread) -> void;
